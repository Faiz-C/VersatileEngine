...
/**
 * An InputProcessor is tasked with understanding WHAT to do with state changes between the game actions.
 * It is responsible for taking the current state of the in game actions and making the game itself respond
 * to them.
 * 
 * For example, if an action such as "MOVE UP" is in use then when the InputProcessor is called it may have
...
public interface IInputProcessor {
     ...
     * to the changes.
     * 
     * @param actionManager -> An ActionManager which has the most up to date states of the in game actions
     */
