...
/**
 * An abstraction for Animations within the Verse Engine. Animations are kept updated based off
...
public abstract class Animation implements IUpdatable, IObserver{
    ...
    /**
     * Returns whether or not the Animation is finished animating its cycles.
     * 
     ...
     * @param x -> The x-coordinate to position the SpriteAnimation
     * @param y -> The y-coordinate to position the SpriteAnimation
     */
