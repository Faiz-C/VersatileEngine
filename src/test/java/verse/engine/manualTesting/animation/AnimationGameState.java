...
public class AnimationGameState extends GameState {
    ...
    private void init(Dimension dimension, Graphics2D g) {
        ...
        try {
            ...
            this.downMovement = new SpriteAnimation(handler.cropRow(2), Animation.STANDARD_DELAY, Animation.INFINITE_LOOP);
            this.leftMovement = new SpriteAnimation(handler.cropRow(3), Animation.DOUBLED_DELAY, Animation.INFINITE_LOOP);
            this.rightMovement = new SpriteAnimation(handler.cropRow(1), Animation.NO_DELAY, Animation.INFINITE_LOOP);
