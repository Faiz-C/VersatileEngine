...
public class AnimationTest extends JPanel implements Runnable{
    ...
    private void drawToScreen() {
        ...
        this.upMovement.draw(this.graphics, 20, 20);
        this.downMovement.draw(this.graphics, 60, 20);
        this.leftMovement.draw(this.graphics, 100, 20);
        this.rightMovement.draw(this.graphics, 140, 20);
